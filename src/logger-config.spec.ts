...
describe('DefaultLoggerConfigImpl', () => {
  it('should be named test', () =>
    expect(
      new DefaultLoggerConfigImpl('test', new RootLoggerConfigImpl(Level.ERROR, [])).name,
    ).toBe('test'));

  it('should have a parent', () => {
    const parent: ILoggerConfig = new RootLoggerConfigImpl(Level.ERROR, []);
  ...
  it('should have a default level of ERROR', () =>
    expect(
      new DefaultLoggerConfigImpl('test', new RootLoggerConfigImpl(Level.ERROR, [])).level,
    ).toBe(Level.ERROR));
...
describe('RootLoggerConfig', () => {
  it('should have a default level of ERROR', () =>
    expect(new RootLoggerConfigImpl(Level.ERROR, []).level).toBe(Level.ERROR));
});
